...
def generate_launch_description():
    ...
    robotiq_description_dir = FindPackageShare(
        "robotiq_2f_description").find("robotiq_2f_description")
    urc_setup_dir = FindPackageShare("ur_controller").find("ur_controller")

    robot_parameters_path = os.path.join(
        dir, "robots", "case_r1", "general.json"
    )

    parameters = {
        "scenario_path": os.path.join(dir, "scenario_r1"),
    ...
    robotiq_robot_description_content = Command(
        [
            ...
            " ",
            os.path.join(robotiq_description_dir, "urdf",
                         "robotiq_2f_85_model.xacro"),
            " ",
            "prefix:=robotiq/"
        ]
    )
    ...
    robotiq_ghost_robot_description_content = Command(
        [
            ...
            " ",
            os.path.join(robotiq_description_dir, "urdf",
                         "ghost_robotiq_2f_85_model.xacro"),
            " ",
            "prefix:=ghost_"
        ]
    )

    robotiq_robot_description = {
        "robot_description": robotiq_robot_description_content}
    robotiq_ghost_robot_description = {
        "robot_description": robotiq_ghost_robot_description_content}
    ...
    ghost_robot_description = {
        "robot_description": ghost_robot_description_content}
    robot_description = {"robot_description": robot_description_content}

    rviz_config_file = os.path.join(dir, "config", "bringup_r2.rviz")
    ...
    driver_parameters = {
        "ur_address": "192.168.100.12",  # robot_parameters["ip_address"],
